...
setenv backup_primary_image 'echo "${fio_msg} backing up primary boot image set ..."; mmc dev ${devnum} 1 && mmc read ${loadaddr} 0x0 0x7FF && mmc dev ${devnum} 2 && mmc write ${loadaddr} 0x0 0x7FF'
setenv restore_primary_image 'echo "${fio_msg} restore primary boot image set ..."; mmc dev ${devnum} 2 && mmc read ${loadaddr} 0x0 0x7FF && mmc dev ${devnum} 1 && mmc write ${loadaddr} 0x0 0x7FF'
